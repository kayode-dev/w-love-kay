...
const Home = () => {
  const message = [
    "Hi, Kayode here… so to address the elephant in the room, you might be wondering why this link made it to your respective DM’s",
    2500,
    ...
    2500,
    " I am rich in the Lord, but quite poor in funds if i suggest getting something for everyone that comes to mind... with that being said, ",
    2500,
    ...
    2500,
    "there will definitely be some typo's, kindly overlook them...",
    2500,
  ...
  return (
    <>
      ...
      <div className="main-body flex flex-col items-center justify-around ">
        <div className="w-11/12 md:w-4/5 bg-neutral-800 rounded-lg p-4 md:p-8 flex flex-col items-center justify-center overflow-y-auto text-center">
          <TypeAnimation
            sequence={message}
            speed={40}
            wrapper="span"
